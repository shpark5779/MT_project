...
image = cv2.imread("labeled-images/lower-gi-tract/pathological-findings/polyps/0004a718-546c-41c2-9c69-c4685093a039.jpg")
def contour_process(Input):
    ...
    [[ 665   92]
     ...
     [ 665  970]]
    '''
    # print(box[0][0],box[2][0],box[0][1],box[3][1])
    croped_img = rgb_img[box[0][1]:box[3][1],box[0][0]:box[2][0]]
    rs_img = cv2.resize(croped_img,(256,256), cv2.INTER_CUBIC)
    # plt.imshow(croped_img)
    # plt.show()
    return rs_img

def read_img(D_path1, D_path2):
...
if __name__ == '__main__':
    path1, path2  = "MT_0/", "MT_1/"
    read_img(path1, path2)
